...
RANDOM_QBER_DATA_PATH_EVE = PATH_TO_PREPARED_RESULTS + PREPARED_DATA_FILENAME + '_' + QBERType.RANDOM + '_eve.csv'
BURSTY_QBER_DATA_PATH = PATH_TO_PREPARED_RESULTS + PREPARED_DATA_FILENAME + '_' + QBERType.BURSTY + '.csv'
BURSTY_QBER_DATA_PATH_EVE = PATH_TO_PREPARED_RESULTS + PREPARED_DATA_FILENAME + '_' + QBERType.BURSTY + '_eve.csv'
...
PREPARED_DATA_HEADER_EVE = ['L', 'N', 'K', 'QBER', 'TAU_MISSES', 'REPETITIONS', 'EVE_SUCCESS', 'EVE_REPETITIONS']
